...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopTagCLoud'
        db.create_table('plugin_coop_tagcloud_plugin_cooptagcloud', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_coop_tagcloud', ['Plugin_CoopTagCLoud'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopTagCLoud'
        db.delete_table('plugin_coop_tagcloud_plugin_cooptagcloud')
    ...
    models = {
        ...
        'plugin_coop_tagcloud.plugin_cooptagcloud': {
            'Meta': {'object_name': 'Plugin_CoopTagCLoud'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_coop_tagcloud']