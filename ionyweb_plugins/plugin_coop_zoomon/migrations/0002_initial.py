...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopZoomOn'
        db.create_table('plugin_coop_zoomon_plugin_coopzoomon', (
            ...
            ('filter', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
        ))
        db.send_create_signal('plugin_coop_zoomon', ['Plugin_CoopZoomOn'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopZoomOn'
        db.delete_table('plugin_coop_zoomon_plugin_coopzoomon')
    ...
    models = {
        ...
        'plugin_coop_zoomon.plugin_coopzoomon': {
            'Meta': {'object_name': 'Plugin_CoopZoomOn'},
            'filter': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_coop_zoomon']