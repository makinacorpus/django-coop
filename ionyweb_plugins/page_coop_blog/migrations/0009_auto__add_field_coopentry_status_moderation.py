...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoopEntry.status_moderation'
        db.add_column('page_coop_blog_coopentry', 'status_moderation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoopEntry.status_moderation'
        db.delete_column('page_coop_blog_coopentry', 'status_moderation')
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'PpR78FfJUr32x2qcQC3UUE'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.calendar': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6G6YzUkqPZisd86oPhLTXc'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'sbGhBHXYL79Fhd2Tmrfpbk'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.engagement': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9tpPoLxN3SUjjuxMnUo3tR'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.evaluation': {
        ...
        'coop_local.event': {
            ...
            'other_organizations': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'rrTHmiDTJJoyXQDHiqTFFX'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'UtqtoRCZvDwJLwfsScjEJB'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.organization': {
            ...
            'evaluation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.Evaluation']", 'null': 'True', 'blank': 'True'}),
            'evaluation_status': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'TukWhkcxvQ9BU9EAPNHJZH'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'prefs': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.PersonPreferences']", 'null': 'True', 'blank': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sites.Site']", 'symmetrical': 'False'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'smmzxmGTXhCrLt77MXXhh5'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.personpreferences': {
            'Meta': {'object_name': 'PersonPreferences'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.Area']", 'null': 'True', 'blank': 'True'}),
            'locations_buffer': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'newsletter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'notification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'organizations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.Organization']", 'null': 'True', 'blank': 'True'}),
            'transverse_themes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.TransverseTheme']", 'null': 'True', 'blank': 'True'}),
            'type_content': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.PersonPreferencesContentTypes']", 'null': 'True', 'blank': 'True'})
        },
        'coop_local.personpreferencescontenttypes': {
            'Meta': {'object_name': 'PersonPreferencesContentTypes'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'})
        },
        ...
        'coop_local.role': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'NNifNvvfzNJcnjcM3sw2kh'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'JZpJyqcBNkn6r8fvxaBPAZ'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'page_coop_blog.coopentry': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'db_index': 'True'}),
            ...
            'status_moderation': ('django.db.models.fields.CharField', [], {'max_length': '1', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'transverse_themes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['coop_local.TransverseTheme']", 'null': 'True', 'blank': 'True'}),
            'zoom_on': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
