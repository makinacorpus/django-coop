...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoopEntry.source'
        db.add_column('page_coop_blog_coopentry', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CoopEntry.category'
        db.alter_column('page_coop_blog_coopentry', 'category_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['page_coop_blog.Category']))

    def backwards(self, orm):
        # Deleting field 'CoopEntry.source'
        db.delete_column('page_coop_blog_coopentry', 'source')


        # User chose to not deal with backwards NULL issues for 'CoopEntry.category'
        raise RuntimeError("Cannot reverse this migration. 'CoopEntry.category' and its values cannot be restored.")
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'gwsjzY7cDd5xo2DyPUhU8Z'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'YnAk63yjrtXXZJURhGeimR'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'vugzfNdtYDQBA2RthXeJyX'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'AJnEeWuhVtDTfDhzfAjo6i'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3ix5vuznrXjRTzstLnJuxV'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'page_coop_blog.coopentry': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)', 'db_index': 'True'}),
