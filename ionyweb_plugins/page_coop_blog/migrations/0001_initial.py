...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_Coop_Blog'
        db.create_table('page_coop_blog_pageapp_coop_blog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('page_coop_blog', ['PageApp_Coop_Blog'])

        # Adding model 'Category'
        db.create_table('page_coop_blog_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categories', to=orm['page_coop_blog.PageApp_Coop_Blog'])),
        ...
        db.create_table('page_coop_blog_coopentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['page_coop_blog.PageApp_Coop_Blog'])),
            ...
            ('category', self.gf('mptt.fields.TreeForeignKey')(related_name='entries', to=orm['page_coop_blog.Category'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 24, 0, 0), db_index=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PageApp_Coop_Blog'
        db.delete_table('page_coop_blog_pageapp_coop_blog')
