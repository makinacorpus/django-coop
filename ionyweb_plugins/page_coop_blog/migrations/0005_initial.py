...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopBlog'
        db.create_table('page_coop_blog_pageapp_coopblog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('page_coop_blog', ['PageApp_CoopBlog'])

        # Adding model 'Category'
        db.create_table('page_coop_blog_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categories', to=orm['page_coop_blog.PageApp_CoopBlog'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['page_coop_blog.Category'])),
        ...
        db.send_create_signal('page_coop_blog', ['Category'])

        # Adding unique constraint on 'Category', fields ['blog', 'slug']
        db.create_unique('page_coop_blog_category', ['blog_id', 'slug'])

        # Adding model 'CoopEntry'
        db.create_table('page_coop_blog_coopentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['page_coop_blog.PageApp_CoopBlog'])),
            ...
            ('key_words', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.ActivityNomenclature'], null=True, blank=True)),
            ('docs', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('category', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='entries', null=True, to=orm['page_coop_blog.Category'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 11, 0, 0), db_index=True)),
        ...
        db.create_unique(m2m_table_name, ['coopentry_id', 'transversetheme_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['blog', 'slug']
        db.delete_unique('page_coop_blog_category', ['blog_id', 'slug'])

        # Deleting model 'PageApp_CoopBlog'
        db.delete_table('page_coop_blog_pageapp_coopblog')

        # Deleting model 'Category'
        db.delete_table('page_coop_blog_category')

        # Deleting model 'CoopEntry'
    ...
    models = {
        ...
        'coop_local.area': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2v8Rxrj9Xj5kFdEs47L7Fg'", 'max_length': '50', 'null': 'True'})
        },
        'coop_local.contact': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7yghwnRgCPgURyjtE4gbrk'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.location': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'h5vHUFLFR7UPkKy2QnTpBS'", 'max_length': '50', 'null': 'True'}),
        ...
        'coop_local.person': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'BocM9pnGsokobwmhdwk7yS'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'coop_local.tag': {
            ...
            'uri': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'uri_mode': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uXTH9YcnTLRi6HDqvxhZ4Y'", 'max_length': '50', 'null': 'True'})
        },
        ...
        'page_coop_blog.coopentry': {
            ...
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 11, 0, 0)', 'db_index': 'True'}),
