...
from .models import Category, CoopEntry

class RssEntries(Feed):
    """
    RSS entries.
    """
    title_template = "page_coop_blog/feeds/entry_title.html"
    description_template = "page_coop_blog/feeds/entry_description.html"
