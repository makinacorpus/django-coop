...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopExchange'
        db.create_table('page_coop_exchange_pageapp_coopexchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_coop_exchange', ['PageApp_CoopExchange'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopExchange'
        db.delete_table('page_coop_exchange_pageapp_coopexchange')
    ...
    models = {
        ...
        'page_coop_exchange.pageapp_coopexchange': {
            'Meta': {'object_name': 'PageApp_CoopExchange'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_coop_exchange']