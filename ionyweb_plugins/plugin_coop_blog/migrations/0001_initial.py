...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopBlog'
        db.create_table('plugin_coop_blog_plugin_coopblog', (
            ...
            ('nb_news', self.gf('django.db.models.fields.IntegerField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('plugin_coop_blog', ['Plugin_CoopBlog'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopBlog'
        db.delete_table('plugin_coop_blog_plugin_coopblog')
    ...
    models = {
        ...
        'plugin_coop_blog.plugin_coopblog': {
            'Meta': {'object_name': 'Plugin_CoopBlog'},
            'blog_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nb_news': ('django.db.models.fields.IntegerField', [], {'max_length': '100', 'blank': 'True'}),
    ...
    complete_apps = ['plugin_coop_blog']