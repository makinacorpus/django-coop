...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopMembers'
        db.create_table('plugin_coop_members_plugin_coopmembers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('members_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('nb_members', self.gf('django.db.models.fields.IntegerField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('plugin_coop_members', ['Plugin_CoopMembers'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopMembers'
        db.delete_table('plugin_coop_members_plugin_coopmembers')
    ...
    models = {
        ...
        'plugin_coop_members.plugin_coopmembers': {
            'Meta': {'object_name': 'Plugin_CoopMembers'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'nb_members': ('django.db.models.fields.IntegerField', [], {'max_length': '100', 'blank': 'True'}),
    ...
    complete_apps = ['plugin_coop_members']