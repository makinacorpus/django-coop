...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopTerritory'
        db.create_table('page_coop_territory_pageapp_coopterritory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_coop_territory', ['PageApp_CoopTerritory'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopTerritory'
        db.delete_table('page_coop_territory_pageapp_coopterritory')
