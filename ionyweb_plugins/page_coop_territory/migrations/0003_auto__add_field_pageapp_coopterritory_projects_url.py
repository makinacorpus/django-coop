...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageApp_CoopTerritory.projects_url'
        db.add_column('page_coop_territory_pageapp_coopterritory', 'projects_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageApp_CoopTerritory.projects_url'
        db.delete_column('page_coop_territory_pageapp_coopterritory', 'projects_url')
