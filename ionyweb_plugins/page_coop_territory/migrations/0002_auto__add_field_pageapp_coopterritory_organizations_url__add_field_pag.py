...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageApp_CoopTerritory.organizations_url'
        db.add_column('page_coop_territory_pageapp_coopterritory', 'organizations_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'PageApp_CoopTerritory.exchanges_url'
        db.add_column('page_coop_territory_pageapp_coopterritory', 'exchanges_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'PageApp_CoopTerritory.agenda_url'
        db.add_column('page_coop_territory_pageapp_coopterritory', 'agenda_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'PageApp_CoopTerritory.blog_url'
        db.add_column('page_coop_territory_pageapp_coopterritory', 'blog_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageApp_CoopTerritory.organizations_url'
        db.delete_column('page_coop_territory_pageapp_coopterritory', 'organizations_url')

        # Deleting field 'PageApp_CoopTerritory.exchanges_url'
        db.delete_column('page_coop_territory_pageapp_coopterritory', 'exchanges_url')

        # Deleting field 'PageApp_CoopTerritory.agenda_url'
        db.delete_column('page_coop_territory_pageapp_coopterritory', 'agenda_url')

        # Deleting field 'PageApp_CoopTerritory.blog_url'
        db.delete_column('page_coop_territory_pageapp_coopterritory', 'blog_url')
    ...
    models = {
        ...
        'page_coop_territory.pageapp_coopterritory': {
            'Meta': {'object_name': 'PageApp_CoopTerritory'},
            'agenda_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'blog_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'exchanges_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organizations_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_coop_territory']