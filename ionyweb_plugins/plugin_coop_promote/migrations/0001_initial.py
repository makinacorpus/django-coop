...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopPromote'
        db.create_table('plugin_coop_promote_plugin_cooppromote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_coop_promote', ['Plugin_CoopPromote'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopPromote'
        db.delete_table('plugin_coop_promote_plugin_cooppromote')
    ...
    models = {
        ...
        'plugin_coop_promote.plugin_cooppromote': {
            'Meta': {'object_name': 'Plugin_CoopPromote'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_coop_promote']