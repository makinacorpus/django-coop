...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopNewsletter'
        db.create_table('page_coop_newsletter_pageapp_coopnewsletter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_coop_newsletter', ['PageApp_CoopNewsletter'])

        # Adding model 'GuestNewsletter'
        db.create_table('page_coop_newsletter_guestnewsletter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('page_coop_newsletter', ['GuestNewsletter'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopNewsletter'
        db.delete_table('page_coop_newsletter_pageapp_coopnewsletter')

        # Deleting model 'GuestNewsletter'
        db.delete_table('page_coop_newsletter_guestnewsletter')
    ...
    models = {
        ...
        'page_coop_newsletter.guestnewsletter': {
        ...
        'page_coop_newsletter.pageapp_coopnewsletter': {
            'Meta': {'object_name': 'PageApp_CoopNewsletter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_coop_newsletter']