...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageApp_CoopService.echanges_url'
        db.delete_column('page_coop_service_pageapp_coopservice', 'echanges_url')

        # Deleting field 'PageApp_CoopService.oragnizations_url'
        db.delete_column('page_coop_service_pageapp_coopservice', 'oragnizations_url')

        # Adding field 'PageApp_CoopService.organizations_url'
        db.add_column('page_coop_service_pageapp_coopservice', 'organizations_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'PageApp_CoopService.exchanges_url'
        db.add_column('page_coop_service_pageapp_coopservice', 'exchanges_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageApp_CoopService.echanges_url'
        db.add_column('page_coop_service_pageapp_coopservice', 'echanges_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'PageApp_CoopService.oragnizations_url'
        db.add_column('page_coop_service_pageapp_coopservice', 'oragnizations_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'PageApp_CoopService.organizations_url'
        db.delete_column('page_coop_service_pageapp_coopservice', 'organizations_url')

        # Deleting field 'PageApp_CoopService.exchanges_url'
        db.delete_column('page_coop_service_pageapp_coopservice', 'exchanges_url')
    ...
    models = {
        ...
        'page_coop_service.pageapp_coopservice': {
            'Meta': {'object_name': 'PageApp_CoopService'},
    ...
    complete_apps = ['page_coop_service']