...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopService'
        db.create_table('page_coop_service_pageapp_coopservice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_coop_service', ['PageApp_CoopService'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopService'
        db.delete_table('page_coop_service_pageapp_coopservice')
