...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopSearchGlobal'
        db.create_table('page_coop_searchglobal_pageapp_coopsearchglobal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organizations_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('exchanges_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('agenda_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('blog_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('projects_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('page_coop_searchglobal', ['PageApp_CoopSearchGlobal'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopSearchGlobal'
        db.delete_table('page_coop_searchglobal_pageapp_coopsearchglobal')
    ...
    models = {
        ...
        'page_coop_searchglobal.pageapp_coopsearchglobal': {
            'Meta': {'object_name': 'PageApp_CoopSearchGlobal'},
            ...
            'projects_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_coop_searchglobal']