...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopContact'
        db.create_table('plugin_coop_contact_plugin_coopcontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('default_subject', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('plugin_coop_contact', ['Plugin_CoopContact'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopContact'
        db.delete_table('plugin_coop_contact_plugin_coopcontact')
    ...
    models = {
        ...
        'plugin_coop_contact.plugin_coopcontact': {
            'Meta': {'object_name': 'Plugin_CoopContact'},
            'default_subject': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
    ...
    complete_apps = ['plugin_coop_contact']