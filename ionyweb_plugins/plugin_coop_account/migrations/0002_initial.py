...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopAccount'
        db.create_table('plugin_coop_account_plugin_coopaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('account_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('plugin_coop_account', ['Plugin_CoopAccount'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopAccount'
        db.delete_table('plugin_coop_account_plugin_coopaccount')
    ...
    models = {
        ...
        'plugin_coop_account.plugin_coopaccount': {
            'Meta': {'object_name': 'Plugin_CoopAccount'},
            'account_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_coop_account']