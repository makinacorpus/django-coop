...
class PartialEventForm(EventForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['organizations'] = forms.ModelMultipleChoiceField(required=False, queryset=Organization.objects.filter(active=True, status='V', is_project=False).order_by('title'))
