...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopAgenda'
        db.create_table('page_coop_agenda_pageapp_coopagenda', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_coop_agenda', ['PageApp_CoopAgenda'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopAgenda'
        db.delete_table('page_coop_agenda_pageapp_coopagenda')
    ...
    models = {
        ...
        'page_coop_agenda.pageapp_coopagenda': {
            'Meta': {'object_name': 'PageApp_CoopAgenda'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_coop_agenda']