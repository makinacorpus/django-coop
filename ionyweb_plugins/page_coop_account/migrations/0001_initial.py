...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_CoopAccount'
        db.create_table('page_coop_account_pageapp_coopaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_coop_account', ['PageApp_CoopAccount'])


    def backwards(self, orm):
        # Deleting model 'PageApp_CoopAccount'
        db.delete_table('page_coop_account_pageapp_coopaccount')
    ...
    models = {
        ...
        'page_coop_account.pageapp_coopaccount': {
            'Meta': {'object_name': 'PageApp_CoopAccount'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['page_coop_account']