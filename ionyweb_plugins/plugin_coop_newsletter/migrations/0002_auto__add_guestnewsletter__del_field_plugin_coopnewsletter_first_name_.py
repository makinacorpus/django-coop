...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GuestNewsletter'
        db.create_table('plugin_coop_newsletter_guestnewsletter', (
        ...
        db.send_create_signal('plugin_coop_newsletter', ['GuestNewsletter'])

        # Deleting field 'Plugin_CoopNewsletter.first_name'
        db.delete_column('plugin_coop_newsletter_plugin_coopnewsletter', 'first_name')

        # Deleting field 'Plugin_CoopNewsletter.last_name'
        db.delete_column('plugin_coop_newsletter_plugin_coopnewsletter', 'last_name')

        # Deleting field 'Plugin_CoopNewsletter.email'
        db.delete_column('plugin_coop_newsletter_plugin_coopnewsletter', 'email')


    def backwards(self, orm):
        # Deleting model 'GuestNewsletter'
        db.delete_table('plugin_coop_newsletter_guestnewsletter')

        # Adding field 'Plugin_CoopNewsletter.first_name'
        db.add_column('plugin_coop_newsletter_plugin_coopnewsletter', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_CoopNewsletter.last_name'
        db.add_column('plugin_coop_newsletter_plugin_coopnewsletter', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_CoopNewsletter.email'
        db.add_column('plugin_coop_newsletter_plugin_coopnewsletter', 'email',
    ...
    models = {
        ...
        'plugin_coop_newsletter.guestnewsletter': {
            'Meta': {'object_name': 'GuestNewsletter'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        'plugin_coop_newsletter.plugin_coopnewsletter': {
            'Meta': {'object_name': 'Plugin_CoopNewsletter'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_coop_newsletter']