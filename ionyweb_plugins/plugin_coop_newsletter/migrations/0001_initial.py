...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopNewsletter'
        db.create_table('plugin_coop_newsletter_plugin_coopnewsletter', (
        ...
        db.send_create_signal('plugin_coop_newsletter', ['Plugin_CoopNewsletter'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopNewsletter'
        db.delete_table('plugin_coop_newsletter_plugin_coopnewsletter')
