...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopSearchGlobal'
        db.create_table('plugin_coop_searchglobal_plugin_coopsearchglobal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_coop_searchglobal', ['Plugin_CoopSearchGlobal'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopSearchGlobal'
        db.delete_table('plugin_coop_searchglobal_plugin_coopsearchglobal')
    ...
    models = {
        ...
        'plugin_coop_searchglobal.plugin_coopsearchglobal': {
            'Meta': {'object_name': 'Plugin_CoopSearchGlobal'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_coop_searchglobal']