...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_CoopExchange'
        db.create_table('plugin_coop_exchange_plugin_coopexchange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('title_rule', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('exchange_url', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('nb_exchanges', self.gf('django.db.models.fields.IntegerField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('plugin_coop_exchange', ['Plugin_CoopExchange'])


    def backwards(self, orm):
        # Deleting model 'Plugin_CoopExchange'
        db.delete_table('plugin_coop_exchange_plugin_coopexchange')
    ...
    models = {
        ...
        'plugin_coop_exchange.plugin_coopexchange': {
            'Meta': {'object_name': 'Plugin_CoopExchange'},
            'exchange_url': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nb_exchanges': ('django.db.models.fields.IntegerField', [], {'max_length': '100', 'blank': 'True'}),
    ...
    complete_apps = ['plugin_coop_exchange']