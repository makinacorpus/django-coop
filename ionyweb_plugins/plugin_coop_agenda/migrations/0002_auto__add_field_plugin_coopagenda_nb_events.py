...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_CoopAgenda.nb_events'
        db.add_column('plugin_coop_agenda_plugin_coopagenda', 'nb_events',
                      self.gf('django.db.models.fields.IntegerField')(default=3, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_CoopAgenda.nb_events'
        db.delete_column('plugin_coop_agenda_plugin_coopagenda', 'nb_events')
    ...
    models = {
        ...
        'plugin_coop_agenda.plugin_coopagenda': {
            'Meta': {'object_name': 'Plugin_CoopAgenda'},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nb_events': ('django.db.models.fields.IntegerField', [], {'max_length': '100', 'blank': 'True'}),
    ...
    complete_apps = ['plugin_coop_agenda']