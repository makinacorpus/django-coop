...
class BaseOrganization(URIModel):
    ...
    acronym = models.CharField(u'sigle de l\'organisation', max_length=100, blank=True, null=True)
    ...
    activities = models.ManyToManyField('ActivityNomenclature', blank=True, null=True,
                                        verbose_name=_(u'activity sectors'))
